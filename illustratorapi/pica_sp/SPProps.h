...
typedef struct SPPropertiesMessage {
	...
	/** Reference count. Increment when a property is acquired, decrement
		when it is released. */
	ai::int32 refCon;
	/** True (non-zero) if this property does not change between sessions
...
typedef struct SPPropertiesSuite {
	...
	/** Creates a new individual property and adds it to a plug-in properties list.
		...
		*/
	SPAPI SPErr (*AddProperty)( SPPropertyListRef propertyList, PIType vendorID, PIType propertyKey, ai::int32 propertyID, PIProperty *p,
				ai::int32 refCon, ai::int32 cacheable, SPPropertyRef *property );
	...
	SPAPI SPErr (*FindPropertyLocal)( SPPropertyListRef propertyList, PIType vendorID, PIType propertyKey,
				ai::int32 propertyID, SPPropertyRef *property );
...
/** Internal */
SPAPI SPErr SPAddProperties( SPPropertyListRef propertyList, PIPropertyList *pList, ai::int32 refCon,
			ai::int32 cacheable );

/** Internal */
SPAPI SPErr SPAddProperty( SPPropertyListRef propertyList, PIType vendorID, PIType propertyKey,
			ai::int32 propertyID, PIProperty *p, ai::int32 refCon, ai::int32 cacheable, SPPropertyRef *property );
...
SPAPI SPErr SPFindPropertyLocal( SPPropertyListRef propertyList, PIType vendorID,
			PIType propertyKey, ai::int32 propertyID, SPPropertyRef *property );
